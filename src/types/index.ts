...
export interface LoanApplication {
  ...
  local_govt_letter: number | null; // document ID
  csee_certificate: number | null; // document ID
  acse_certificate: number | null; // document ID
  title_deed: number | null; // document ID
  vehicle_reg_card: number | null; // document ID
  insurance_card: number | null; // document ID
